...
public class TestMax extends Application {
...
//		b1.setStyle("-fx-background-color: lightBlue");
		...
		b1.setOnAction(new EventHandler<ActionEvent>()
		{
			...
			inputValuesList.add(Double.parseDouble(t.getText()));
		...
		b2.setOnAction(new EventHandler<ActionEvent>() {
			...
			Plot plot2 = new Plot(
					x->Double.parseDouble(t.getText())*x,
					0,8,0,
					axes
					
					);
			
			Pane layout = new Pane(plot,plot1,plot2);
